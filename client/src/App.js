...
import PoliceForgotPassword from './Components/Police/PoliceForgotPassword';
  ...
  return (
    ...
    <div className="App">
      <Routes>
        ...
        <Route path='/citizen_forgotpassword' element={[<Navbar/>,<CitizenForgotPassword/>]} />
        ...
        <Route path='/police_forgotpassword' element={[<Navbar/>,<PoliceForgotPassword/>]} />
