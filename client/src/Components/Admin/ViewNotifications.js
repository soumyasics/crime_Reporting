        ...
        <tbody>
          {crimeAlerts.map(alert => (
            <tr key={alert.id}>
              ...
              <td className='crime-alerts-table-th-td'><Link to='/admin-viewNotificationDetails'><button className="view-notification-details-btn">View Details</button></Link></td>
            </tr>
          ))}
        </tbody>
      </table>
